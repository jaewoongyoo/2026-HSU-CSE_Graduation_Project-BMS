...
object BatteryUtils {
    fun getCurrentBatteryState(context: Context, deviceId: Int, sessionId: Int): BatteryLog {
        ...
        return BatteryLog(
            ...
            current = bm.getIntProperty(BatteryManager.BATTERY_PROPERTY_CURRENT_NOW) / 1000, // mA 단위
